...
6. **The Neomatrix moves with the fix, same PR (§21.2.1).** Rogue nodes deleted, surfaces repointed, blind spots modelled with their `semanticKey`; `neomatrix:check` green before push.
