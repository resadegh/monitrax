...
- **Reviewer enforcement:** reject any fix PR that resolves a defect without moving its registry entry through the lifecycle (with the test/sweep the gate requires), or that ships a new substantive defect discovery without an entry.
