...
**Last verified against HEAD:** `818a2db` (merge of #1418) · **on:** 2026-07-15 · **by:** Cowork "The Matrix" — VR-007 CONSOLIDATION: the VR-007 intake was renumbered **+2 → MON-053…MON-074** (its original MON-051…MON-072 collided with the Matrix-ingestion MON-051/052 registered in #1418). Any reference to VR-007's internal numbering maps +2.
