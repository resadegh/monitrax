 ...
 * module gate for this subtree. When MODULE_STRATEGY is OFF (the v1 ship
...
export default async function PropertyStrategyModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_STRATEGY');
  return <>{children}</>;
}
