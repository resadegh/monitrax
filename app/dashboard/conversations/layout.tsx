 ...
 * module gate for this subtree. When MODULE_SOCIAL is OFF (the v1 ship
...
export default async function ConversationsModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_SOCIAL');
  return <>{children}</>;
}
