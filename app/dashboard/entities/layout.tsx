 ...
 * module gate for this subtree. When MODULE_ENTITIES is OFF (the v1 ship
...
export default async function EntitiesModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_ENTITIES');
  return <>{children}</>;
}
