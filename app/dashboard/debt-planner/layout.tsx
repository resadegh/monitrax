 ...
 * module gate for this subtree. When MODULE_DEBT_PLANNER is OFF (the v1 ship
...
export default async function DebtPlannerModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_DEBT_PLANNER');
  return <>{children}</>;
}
