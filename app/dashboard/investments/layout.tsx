 ...
 * module gate for this subtree. When MODULE_INVESTMENTS is OFF (the v1 ship
...
export default async function InvestmentsModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_INVESTMENTS');
  return <>{children}</>;
}
