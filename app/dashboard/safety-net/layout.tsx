 ...
 * module gate for this subtree. When MODULE_SAFETY_NET is OFF (the v1 ship
...
export default async function SafetyNetModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_SAFETY_NET');
  return <>{children}</>;
}
