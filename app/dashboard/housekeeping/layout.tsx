 ...
 * module gate for this subtree. When MODULE_HOUSEKEEPING is OFF (the v1 ship
...
export default async function HousekeepingModuleLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  await moduleRouteGuard('MODULE_HOUSEKEEPING');
  return <>{children}</>;
}
