...
**Last updated:** 2026-05-01 (afternoon) — Reza + Claude (WIF Phase 9: OIDC fix shipped, now blocked at mTLS handshake — Cloud SQL instance is rejecting the ephemeral client cert; GCP-side config verification needed)
