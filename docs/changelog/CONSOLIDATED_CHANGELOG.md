...
- **Type:** docs (Phase A gate deliverable) | **Scope:** `docs/architecture/NUMBER_INVENTORY.md` (the decision artefact), `docs/architecture/contracts/` (49 Quantity Contracts), `scripts/census/producers-census.mjs` (Phase A0 census extension — committed earlier today), NO production code.
