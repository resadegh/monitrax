...
- **Process**: FIX_PROTOCOL §7 ledger retro (Stage-2 gate change: name the session principal for every new surface); registry MON-094 fixPRs += #1478 (stays FIXING until VR-022); structural graph −2 admin files +3 housekeeping files.
