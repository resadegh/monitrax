...
| **Anthropic Claude API** (queued — Phase 33g.2 live AI feedback chat) | Live AI chat in feedback drawer; Reza-approved synthesis summaries | Per-token. Haiku 4.5 cheap; Opus 4.7 expensive. With prompt caching expect $0.10–0.30 per feedback thread | ~AU$5–25 | _fill_ | **NEW vendor — ship cap before code lands**: $50/mo budget at console.anthropic.com → Settings → Limits |
