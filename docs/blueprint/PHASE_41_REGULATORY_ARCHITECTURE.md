...
> - **41e.1 (Div 115 + Div 6 basic + capital loss netting)** — slice A (PR #644 — Div 115 CGT discount module + 24 tests), slice B (PR #645 — capital loss netting + s100-50 / s115-100 / Div 102-A + 18 tests), slice C (PR #647 — Div 6 basic via `trustDistribution.ts` + s99A 47% penalty + UC-S100A-RISK / UC-DIV-6E-STREAMING / UC-S98 flags + 20 tests). Slice D (router wiring) queued.
