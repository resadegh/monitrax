...
*Phase 56 v1.7 — 56.8 hub layout + one-list Review + 56.8b desktop row refresh. Governed by §12.2.1 (one list/source), §18.2.1 (cleaner-refresh live-verified), §20.5, §0 (architect: retire the duplicate; designer: Mercury-tier desktop row; psychology: clean hub + familiar list).*
