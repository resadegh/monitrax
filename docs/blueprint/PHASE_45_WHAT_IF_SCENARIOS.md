...
5. 🟡 **Q-DEC PR 3 — engine-by-engine cutover (IN FLIGHT — 4 sub-PRs landed; 2 queued)** — Reza decision 2026-06-06: 5-way split for review tractability (3.A composers / 3.B tax routes / 3.B.2 tax salary+super / 3.C cfo / 3.D AI tools / 3.E UI). `serializeDecimalsForJson` is the canonical Decimal → JSON boundary walker (PR 3.B).
   ...
   - ⏳ **PR 3.D — AI advisor tools cutover** (next) — `lib/ai/tax-advisor/tools/*` consume Decimal engines via `runScenarioDecimal` + tax-engine Decimal siblings.
