...
**§18.7.4 replicate queue remaining (queued, no commitment):** SMSF detail hero — applies the §18.7.5 Asset Spotlight template (sub-palette stays sky→indigo Stage I Invest; KPI mapping per the §18.7.5 table). Income-page banner application is a lower-priority candidate.
