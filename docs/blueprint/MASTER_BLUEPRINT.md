...
| **41f** | Xero Bidirectional Sync | 📋 Planned (~10 days) | Phase 41a-d shipped personal Xero OAuth + balance-sheet/P&L import; PROD ships full bidirectional sync + transaction-level data + multi-org. |
