...
| **41e** | Entity-Aware Tax Engine | 📋 Planned (~28 days) | Full Div 6/6E correct trust distribution, s100A safe harbour, Div 7A decision tree, Part IVA, FTE/IEE, PSI per TR 2022/3, super contribution caps, Div 293, Div 296, TBC, LRBA per PCG 2016/5. Authority-mapped per `docs/blueprint/PHASE_41_REGULATORY_ARCHITECTURE.md`. |
...
| **41h** | AI Entity-Aware Diagnosis | 📋 Planned (~7 days) | AI advice composing entity tree + money flow + tax engine into specific recommendations. Depends on Phase 41e. |
