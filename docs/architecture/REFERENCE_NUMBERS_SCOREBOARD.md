...
- **40 quantities** tracked · **1251 producing sites** across `lib/`, `app/api/`, `app/dashboard/`, `components/`
- **5/40** join to a Neomatrix `semanticKey`; **35 do not**
- **13/40** have a same-named quantity contract
- **`loanCost` is at 31** — T2 is the tranche that takes it to one. That single number is the fairest test of the programme so far.
...
| Quantity | 2026-07-29#1 | 2026-07-29#2 | 2026-07-30 | 2026-07-31#4 | 2026-07-31#5 | now |
|---|---:|---:|---:|---:|---:|---:|
| `assetsLiabilitiesBreakdown` | — | 24 | 24 | 24 | 24 | 24 |
| `budgetVariance` | — | 21 | 21 | 20 | 20 | 20 |
| `cashflow` | 59 | 59 | 59 | 57 | 57 | 57 |
| `cgt` | — | 98 | 98 | 98 | 98 | 98 |
| `deductions` | — | 105 | 107 | 106 | 105 | 105 |
| `depreciation` | 15 | 15 | 15 | 15 | 15 | 15 |
| `div293` | — | 4 | 4 | 4 | 4 | 4 |
| `emergencyMonths` | 14 | 14 | 15 | 15 | 14 | 14 |
| `expenseRunRate` | 84 | 84 | 87 | 81 | 79 | 79 |
| `forecastFlows` | — | 70 | 70 | 69 | 69 | 69 |
| `freedomHorizon` | — | 6 | 6 | 6 | 6 | 6 |
| `fteIeeElections` | — | 13 | 13 | 13 | 13 | 13 |
| `grossIncome` | — | 43 | 47 | 38 | 36 | 36 |
| `gst` | — | 15 | 15 | 15 | 15 | 15 |
| `healthScore` | — | 19 | 19 | 19 | 19 | 19 |
| `incomeRunRate` | 135 | 135 | 141 | 128 | 126 | 126 |
| `incomeTax` | 77 | 77 | 77 | 76 | 76 | 76 |
| `insuranceAdequacy` | — | 15 | 16 | 15 | 15 | 15 |
| `investmentReturns` | — | 22 | 22 | 22 | 22 | 22 |
| `landTax` | — | 8 | 8 | 8 | 8 | 8 |
| `liquidCash` | — | 58 | 58 | 58 | 58 | 58 |
| `loanAmortisation` | — | 8 | 8 | 8 | 8 | 8 |
| `loanCost` | 32 | 32 | 32 | 31 | 31 | 31 |
| `lvrGearing` | — | 39 | 39 | 39 | 39 | 39 |
| `medicareLevy` | 26 | 26 | 26 | 20 | 20 | 20 |
| `moneyStoryMargin` | — | 6 | 6 | 6 | 6 | 6 |
| `negativeGearing` | — | 6 | 7 | 7 | 7 | 7 |
| `netIncome` | — | 45 | 46 | 34 | 33 | 33 |
| `netWorth` | 7 | 7 | 7 | 7 | 7 | 7 |
| `payg` | 64 | 64 | 73 | 56 | 54 | 54 |
| `propertyCashflowYield` | — | 6 | 6 | 6 | 6 | 6 |
| `propertyEquity` | 11 | 11 | 11 | 11 | 11 | 11 |
| `propertyValuationGrowth` | — | 6 | 6 | 6 | 6 | 6 |
| `psiAttribution` | — | 11 | 11 | 11 | 11 | 11 |
| `savingsRate` | 30 | 30 | 30 | 30 | 30 | 30 |
| `stampDuty` | — | 4 | 4 | 4 | 4 | 4 |
| `superCap` | 10 | 10 | 10 | 10 | 10 | 10 |
| `superProjection` | — | 3 | 3 | 3 | 3 | 3 |
| `taxOffsetsFranking` | — | 50 | 50 | 48 | 48 | 48 |
| `taxableIncome` | — | 38 | 41 | 38 | 38 | 38 |
