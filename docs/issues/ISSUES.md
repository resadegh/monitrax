...
| MON-128 | 🟠 FIXING | 🔴 | yes | aggregateIncome has NO one-off gate and 'net' is only net for SALARY — quickMetrics.monthlyIncome reads $41,303/mo ($495,636/yr) labelled net-of-PAYG against the app's own declared GROSS of $317,751/yr | ##1542 (T1-A scaffold), ##1545 (T1-B flip) | — |
...
| MON-140 | 🟠 FIXING | 🔴 | yes | masterFinancialService fed the ONE banked engine a select-narrowed income row missing isRecurring — one-off rows annualised x12 ($158,401.44/yr) while moneyFlow read the same engine correctly | ##1548 (merged 2026-07-31) | ✅ |
...
**🟠 FIXING** · 🔴 critical · changes numbers: **yes** · area: income · opened 2026-07-30
...
**🟠 FIXING** · 🟠 high · changes numbers: **yes** · area: tax · opened 2026-07-30
...
- **Neomatrix:** `engine.tax.payg.calculatePAYG`
