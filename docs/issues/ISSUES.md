...
| MON-053 | 🟠 FIXING | 🔴 | yes | One-off income annualised x12 into the tax base — two single ATO deposits become ~$120.6K phantom recurring income | ##PENDING | ✅ |
...
**🟠 FIXING** · 🔴 critical · changes numbers: **yes** · area: tax · opened 2026-07-15
