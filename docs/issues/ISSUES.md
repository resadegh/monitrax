...
**🔵 OPEN** · 🟢 low · changes numbers: **no** · area: documents · opened 2026-07-14
...
Auto-raised by issues:raise (NeoAudit finding bus, §3.1). Node: R3-eyes cross-surface. Surface: app/dashboard/documents. Expected: consistent doc count + storage across Settings and the Vault. Actual: Settings 24 docs / 12MB vs Documents/Vault 6 all-time / 14.0 MB. Evidence/run: VR-006.
