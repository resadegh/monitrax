...
| MON-002 | 🟢 VERIFIED | 🟠 | yes | Per-property cashflow computed inline (declared, not canonical/actuals) -> loan cost silently $0 + SSOT drift | #1336 | ✅ |
...
| MON-009 | 🟢 VERIFIED | 🟠 | yes | Rental (and any linked line) shown per declared frequency, fragmented across records → over-counted; not read from transaction dates | #1337 | ✅ |
| MON-010 | 🟢 VERIFIED | 🟡 | yes | Tax summary still sums raw (fragmented) rental income records — taxable rental over-counted | #1353 | ✅ |
| MON-011 | 🟢 VERIFIED | 🟠 | yes | Portfolio equity sums FLOORED per-property equities — overstated by exactly $37,076 | #1347 | ✅ |
| MON-012 | 🟢 VERIFIED | 🟠 | yes | Balances liquidity buckets fail L3 tie-out by exactly $64,572 (floored equity + credit card + HECS) | #1347 | ✅ |
| MON-013 | 🟢 VERIFIED | 🔴 | yes | Investment-account CASH ($67,871) excluded from net worth & total assets; Assets TILE includes it — two producers of 'total assets' | #1342 | ✅ |
| MON-014 | 🟢 VERIFIED | 🟠 | yes | Home per-property tiles show rent-magnitude not cashflow when a loan lacks minRepayment — 3rd non-canonical cashflow producer (portfolio/snapshot) drops loan cost to $0, bypassing #1336/#1337 | #1351 | ✅ |
...
| MON-019 | 🟢 VERIFIED | 🟠 | yes | 'Save 69 years' = the 999-month payoff SENTINEL leaking into UI arithmetic; refinance recommended on a 104% LVR loan | #1348 | ✅ |
...
| MON-021 | 🟢 VERIFIED | 🟠 | yes | /cashflow renders actual and declared side-by-side unlabelled (In $0 vs In +$43,736) and two month-end forecasts disagree by $39K | #1354 | ✅ |
...
| MON-091 | 🟢 VERIFIED | 🟠 | yes | Rental/income links lock in a MONTHLY default: no frequency control in the link dialog + reuse paths never revisit cadence | ##1468 | ✅ |
...
**🟢 VERIFIED** · 🔴 critical · changes numbers: **yes** · area: core · opened 2026-07-07
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **yes** · area: dashboard · opened 2026-07-07
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **yes** · area: cfo · opened 2026-07-07
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **yes** · area: cashflow · opened 2026-07-07
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **yes** · area: income · opened 2026-07-20
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **no** · area: income · opened 2026-07-20
...
**🟢 VERIFIED** · 🔴 critical · changes numbers: **yes** · area: properties · opened 2026-07-20
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **yes** · area: tax · opened 2026-07-20
...
**🟢 VERIFIED** · 🟠 high · changes numbers: **no** · area: intake · opened 2026-07-23
...
**🔵 OPEN** · 🟠 high · changes numbers: **yes** · area: tax · opened 2026-07-27

> **What was wrong:** A verification check found a mismatch on app/dashboard/entities/[id]/tax/page.tsx (no PSI questionnaire) + prisma (no PsiAssessment model) + lib/services/entityTaxFactsAssembler.ts.
>
- **Holistic test (§19.4):** ⚠ required before VERIFIED/CLOSED
- **Detail:** `docs/blueprint/NEOAUDIT.md#5-the-ratchet-zero-fail-mechanism`

Auto-raised by issues:raise (NeoAudit finding bus, §3.1). Surface: app/dashboard/entities/[id]/tax/page.tsx (no PSI questionnaire) + prisma (no PsiAssessment model) + lib/services/entityTaxFactsAssembler.ts.
