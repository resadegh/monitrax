...
| MON-045 | 🟠 FIXING | 🟠 | yes | CFO neg-gearing benefit ($157,746) ~4x total deductions ($39,554) — internally inconsistent | ##1415 (stage 1: canonical helper), ##1425 (stage 2: wiring + producer deletions) | ✅ |
...
**🟠 FIXING** · 🟠 high · changes numbers: **yes** · area: tax · opened 2026-07-14
