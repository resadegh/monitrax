...
| MON-130 | 🟠 FIXING | 🔴 | yes | CLASS SWEEP 2: 12 producers under lib/ read raw loan.minRepayment as a monthly cost — interest-only loans silently cost $0, and moneyFlowService SKIPS them entirely (root cause of the Activity 'Loans $106K/yr' vs canonical $12,779) | ##1574 | ✅ |
...
| MON-147 | ✅ CLOSED | 🟡 | no | Layer 0 carried a node for a function deleted in T1-B — the coverage gate reconciles files and hashes, never symbols, so a ghost node went unnoticed for days | ##1574 | n/a |
