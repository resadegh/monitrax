...
| MON-128 | 🔵 OPEN | 🔴 | yes | aggregateIncome has NO one-off gate and 'net' is only net for SALARY — quickMetrics.monthlyIncome reads $41,303/mo ($495,636/yr) labelled net-of-PAYG against the app's own declared GROSS of $317,751/yr | — | — |
