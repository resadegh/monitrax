      ...
      <div className="mx-auto max-w-3xl px-6 py-24 sm:py-32 text-center">
        ...
        <Reveal delay={0.12}>
          <p className="mx-auto mt-4 max-w-xl text-lg text-stone-400" style={{ lineHeight: 1.6 }}>
            Start with what you already have: property, loans, super,
            investments, cashflow and the decision you are trying to make next.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.24}>
          <div className="mt-10">
            ...
            <p className="mt-4">
              ...
              >
                Or take the 60-second TRAIL Check first &rarr;
              </Link>
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.36}>
          <p className="mt-12 text-sm text-stone-600 italic">
            Your TRAIL starts with one practical step: seeing what you have
            built in one place.
          </p>
        </Reveal>
      </div>
