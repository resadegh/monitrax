            ...
            return (
              <div key={stage.letter} className="relative flex flex-1 min-w-0 items-center justify-center px-1">
                ...
                >
                  ...
                  {/* "You" pill above the current stage tile removed
                      per Reza directive 2026-05-08 — the spotlight
                      panel below the tiles already shows "You are here"
                      via the `<span>` next to the stage name; the pill
                      duplicated the signal AND visually overlapped the
                      letter itself. The same-row "You are here" chip
                      next to "Stage X — Y" remains the canonical "you
                      are here" affordance. */}
                </motion.button>
              </div>
            );
